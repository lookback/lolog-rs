...
mod tests {
    ...
    mod network_tests {
        ...
        fn test_format_log_record() {
            ...
            let expected = "<132>1 2021-03-18T13:12:27.000+00:00 localhost test 1234 1234 [api_key_id@53595 apiKey=\"api_key\" env=\"test\"] Hello, World! {\"recordingId\":\"evANFeLHHB58N3mtF\"}\n";
